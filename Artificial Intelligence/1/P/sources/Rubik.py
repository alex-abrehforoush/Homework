...
def frontPrime(cube):
	...
	#red
	new_cube = rotatePrime(new_cube, 2)
	#blue
...
def backPrime(cube):
	...
	#orange
	new_cube = rotatePrime(new_cube, 4)
	#yellow
...
def rightPrime(cube):
	...
	#blue
	new_cube = rotatePrime(new_cube, 3)
	#orange
...
def leftPrime(cube):
	...
	#green
	new_cube = rotatePrime(new_cube, 1)
	#red
...
def upPrime(cube):
	new_cube = cube.copy()
	#white
	new_cube = rotatePrime(new_cube, 0)
	#green
...
def downPrime(cube):
	...
	#yellow
	new_cube = rotatePrime(new_cube, 5)
...
def getNeighbors(cube):
	...
	neighbor[1] = frontPrime(cube.copy())
	neighbor[2] = back(cube.copy())
	neighbor[3] = backPrime(cube.copy())
	neighbor[4] = right(cube.copy())
	neighbor[5] = rightPrime(cube.copy())
	neighbor[6] = left(cube.copy())
	neighbor[7] = leftPrime(cube.copy())
	neighbor[8] = up(cube.copy())
	neighbor[9] = upPrime(cube.copy())
	neighbor[10] = down(cube.copy())
	neighbor[11] = downPrime(cube.copy())

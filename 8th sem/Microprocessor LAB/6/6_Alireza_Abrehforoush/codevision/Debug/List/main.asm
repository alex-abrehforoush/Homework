...
_0x0:
	.DB  0x41,0x44,0x43,0x20,0x25,0x64,0x3A,0x20
	.DB  0x25,0x64,0x2E,0x25,0x64,0x6D,0x76,0x0
	.DB  0x6E,0x65,0x77,0x3E,0x41,0x44,0x43,0x25
	.DB  0x64,0x3A,0x25,0x63,0x25,0x64,0x6D,0x76
	.DB  0x0
_0x2040003:
	.DB  0x80,0xC0
_0x20A0060:
...
SUBOPT_0x5:
	LDD  R30,Y+6
	LDI  R31,0
	SUBI R30,LOW(-_firstUpdateDone)
	SBCI R31,HIGH(-_firstUpdateDone)
	RET
...
SUBOPT_0x6:
	...
	LD   R1,X
	LDD  R30,Y+6
	LDI  R26,LOW(_previous_data)
	LDI  R27,HIGH(_previous_data)
	LDI  R31,0
	LSL  R30
	ROL  R31
	ADD  R26,R30

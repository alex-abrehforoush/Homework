...
_0x20000:
	...
	.DB  0x3A,0x25,0x30,0x32,0x64,0x20,0x20,0x0
	.DB  0x43,0x45,0x3A,0x25,0x34,0x64,0x20,0x2A
	.DB  0x2A,0x20,0x0,0x35,0x30,0x55,0x53,0x35
	.DB  0x0
_0x2040060:
	.DB  0x1
_0x2040000:
...
; 0001 0016 displayCapacity(capacity);
	CALL SUBOPT_0x4
	RCALL _displayCapacity
; 0001 0017 displayPeriod();
	RCALL _displayPeriod
; 0001 0018 }
	RET
; .FEND
;void stopwatch()
...
; 0002 0061 initializePorts();
	RCALL _initializePorts
; 0002 0062 
; 0002 0063 initializeTimers();
	RCALL _initializeTimers
; 0002 0064 
; 0002 0065 initializeExternalInterrupts();
	RCALL _initializeExternalInterrupts
; 0002 0066 
; 0002 0067 initializeLCD();
	RCALL _initializeLCD
; 0002 0068 }
	RET
; .FEND
	#ifndef __SLEEP_DEFINED__

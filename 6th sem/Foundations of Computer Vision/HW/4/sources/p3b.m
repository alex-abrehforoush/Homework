...
C51 = imread("images\Q3\Puzzle_2_160\Corner_10_1.tif");
C58 = imread("images\Q3\Puzzle_2_160\Corner_10_16.tif");
...
for i = 1: number_of_pieces
    patches(i, :, :, :) = imread(['images\Q3\Puzzle_2_160\' 'Patch_' num2str(i) '.tif']);
end

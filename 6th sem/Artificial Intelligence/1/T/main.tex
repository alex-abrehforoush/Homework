...
\pagestyle{fancy}
\fancyhf{}
\rhead{تکلیف اول درس هوش مصنوعی (بخش تئوری)}
\lhead{\thepage}
...
\section{نمایش مسئله \lr{Hop-Constrained Minimum Spanning Tree}}
هر \lr{Candidate solution} در این مسئله را می‌توان نظیر یک رشته‌ی باینری به طول تعداد یال‌های موجود در گراف نمایش داد به طوری که صفر (یک) بودن بیت $i$ام به معنی قرار داشتن (نداشتن) آن یال در مجموعه‌ی یال‌های نظیر آن \lr{Candidate solution} می‌باشد. همچنین مجموعه‌ی همسایگی نظیر یک \lr{Candidate solution} را می‌توان به شکل مجموعه‌ی همه‌ی رشته‌هایی که با رشته مذکور دقیقا در یک بیت اختلاف دارند، تعریف کرد.


\section{نمایش مسئله \lr{Equal Piles}}
...
\section{ارزیابی افزایشی تابع هدف برای \lr{Quadratic Assignment Problem}}
...
\section{الگوريتم ژنتيك براي مسئله \lr{Bin Packing}}
...
\section{الگوريتم ژنتيك براي مسئله \lr{Magic Square}}
\subsection{\lr{representation (definition of individuals)}}

...
imtool close all
%%%%%%%%%%%%%%%%
temp = imread("images\Puzzle\Puzzle_3_40\Corner_1_1.tif");
r = size(temp, 1);
temp = imread("images\Puzzle\Puzzle_3_40\Shuffled_Patches.tif");
row = size(temp, 1);
column = size(temp, 2);
number_of_pieces = (row / r) * (column / r) - 4;
C11 = imread("images\Puzzle\Puzzle_3_40\Corner_1_1.tif");
C18 = imread("images\Puzzle\Puzzle_3_40\Corner_1_8.tif");
C51 = imread("images\Puzzle\Puzzle_3_40\Corner_5_1.tif");
C58 = imread("images\Puzzle\Puzzle_3_40\Corner_5_8.tif");
...
for i = 1: number_of_pieces
    patches(i, :, :, :) = imread(['images\Puzzle\Puzzle_3_40\' 'Patch_' num2str(i) '.tif']);
end

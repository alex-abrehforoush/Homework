...
(q - g) + (r - h) + (s - i)
$
می‌شود. از برابری سطح روشنایی‌های به دست آمده از دو روش نتیجه می‌گیریم که اعمال توالی فیلترهای یک بعدی هموارکننده افقی و بعد مشتق‌گیری عمودی معادل با اعمال فیلتر \lr{Prewitt} در جهت عمودی خواهد بود.
\begin{figure}[H]
    \centering

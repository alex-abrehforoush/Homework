...
\subsection{}
\lr{Data Augmentation} شامل اعمال تبدیلات مختلف بر داده‌های آموزش، مانند چرخش‌ها، وارونه‌ها و جابجایی‌ها می‌شود. این می‌تواند به مدل کمک کند تا مقاومت بیشتری در برابر \lr{overfitting} پیدا کرده و با تغییرات در داده ورودی بهتر تعمیم پیدا کند. \lr{Data Augmentation} تکنیک خصوصاً زمانی که مجموعه داده محدود است. این می‌تواند با ارائه مدل به یک طیف گسترده‌تر از تغییرات در داده‌های آموزش، از \lr{overfitting} کاسته و توانایی بهتری در تعمیم ایجاد کند.

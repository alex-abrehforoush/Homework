...
\hline
\textbf{\lr{Branch}}       &                      & \lr{Managed by}       & \lr{Provided by}       & \lr{Employes}       &                    & \lr{Serves}        & \lr{Caters}                & \lr{Has}                & \lr{Services}          &                          \\
\hline
\textbf{\lr{Manager}}      & \lr{Manages}         & \lr{Superior to}      &                        &                     &                    &                    &                            &                         &                        &                          \\
\hline
\textbf{\lr{Provider}}     & \lr{Provides}        &                       &                        &                     &                    &                    &                            &                         &                        &                          \\
\hline
\textbf{\lr{Staff}}        & \lr{Employed by}     &                       &                        &                     & \lr{Works in}      &                    &                            &                         &                        &                          \\
\hline
\textbf{\lr{Time}}         &                      &                       &                        & \lr{Is assigned to} &                    &                    &                            &                         &                        &                          \\
\hline

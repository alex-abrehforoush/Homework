...
\begin{tabular}{llllllllllllll}
                           & \textbf{\lr{Branch}} & \textbf{\lr{Manager}} & \textbf{\lr{Provider}} & \textbf{\lr{Cook}}  & \textbf{\lr{Waiter}} & \textbf{\lr{Worker}} & \textbf{\lr{Driver}} & \textbf{\lr{Time}} & \textbf{\lr{Food}} & \textbf{\lr{Organization}} & \textbf{\lr{Complaint}} & \textbf{\lr{Customer}} & \textbf{\lr{Ingredient}} \\
\textbf{\lr{Branch}}       &                      & \lr{Managed by}       & \lr{Provided by}       & \lr{Employes}       & \lr{Employes}        & \lr{Employes}        & \lr{Employes}        &                    & \lr{Serves}        & \lr{Caters}                & \lr{Has}                & \lr{Services}          &                          \\
\textbf{\lr{Manager}}      & \lr{Manages}         & \lr{Superior to}      &                        &                     &                      &                      &                      &                    &                    &                            &                         &                        &                          \\
\textbf{\lr{Provider}}     & \lr{Provides}        &                       &                        &                     &                      &                      &                      &                    &                    &                            &                         &                        &                          \\
\textbf{\lr{Cook}}         & \lr{Employed by}     &                       &                        &                     &                      &                      &                      & \lr{Works in}      &                    &                            &                         &                        &                          \\
\textbf{\lr{Waiter}}       & \lr{Employed by}     &                       &                        &                     &                      &                      &                      & \lr{Works in}      &                    &                            &                         &                        &                          \\
\textbf{\lr{Worker}}       & \lr{Employed by}     &                       &                        &                     &                      &                      &                      & \lr{Works in}      &                    &                            &                         &                        &                          \\
\textbf{\lr{Driver}}       & \lr{Employed by}     &                       &                        &                     &                      &                      &                      & \lr{Works in}      &                    &                            &                         &                        &                          \\
\textbf{\lr{Time}}         &                      &                       &                        & \lr{Is assigned to} & \lr{Is assigned to}  & \lr{Is assigned to}  & \lr{Is assigned to}  &                    &                    &                            &                         &                        &                          \\
